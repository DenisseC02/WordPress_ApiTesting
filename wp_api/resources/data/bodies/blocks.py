create_block_schema = 'wp_api/resources/data/schemas/create_block_schema.json'
read_block_schema = 'wp_api/resources/data/schemas/read_block_schema.json'
wrong_status_schema = 'wp_api/resources/data/schemas/data_error_block_schema.json'
