create_block_schema = 'wp_api/resources/data/schemas/blocks/create_block_schema.json'
read_block_schema = 'wp_api/resources/data/schemas/blocks/read_block_schema.json'
wrong_status_schema = 'wp_api/resources/data/schemas/blocks/data_error_block_schema.json'
