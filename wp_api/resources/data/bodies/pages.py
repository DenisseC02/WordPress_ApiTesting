...
body_test4_post = {'title':'Page from robot', 'content':'This page is has password', 'status':'publish', 'password':'Pasuconsumo'}
...
body_test7_post1 = {'title':'Robot page','content':'Welcome to the robot page', 'status':'publish', 'parent':'10'}
body_test7_post2 = {'title':'New robot title','content':'This page was created by robot', 'status':'publish', 'parent':'10'}
body_test7_post3 = {'title':'Hi from robot','content':'Hello from robot', 'status':'publish', 'parent':'10'}
body_test8_post1 = {'title':'Robot page!','content':'Welcome to the new page', 'status':'publish', 'parent':'13'}
body_test8_post2 = {'title':'Robot page','content':'Page to delete', 'status':'publish', 'parent':'13'}
body_test8_post3 = {'title':'New robot title','content':'This page was created by robot', 'status':'publish', 'parent':'13'}
body_test9_post = {}
...
body_test11_post = {'title':'New robot title','content':'Page to edit!', 'status':'publish', 'parent':'13'}
...
path_list_schema = r'wp_api\resources\data\schemas\pages\list_page.json'
path_create_schema = r'wp_api\resources\data\schemas\pages\create_page.json'
path_delete_schema = r'wp_api\resources\data\schemas\pages\delete_page.json'
path_update_schema = r'wp_api\resources\data\schemas\pages\update_page.json'
