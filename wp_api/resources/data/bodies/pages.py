...
body_test7_post1 = {'title':'Robot page','content':'Welcome to the robot page', 'status':'publish', 'parent':'1'}
body_test7_post2 = {'title':'New robot title','content':'This page was created by robot', 'status':'publish', 'parent':'1'}
body_test7_post3 = {'title':'Hi from robot','content':'Hello from robot', 'status':'publish', 'parent':'2'}
body_test8_post1 = {'title':'Robot page!','content':'Welcome to the new page', 'status':'publish', 'parent':'3'}
body_test8_post2 = {'title':'Robot page','content':'Page to delete', 'status':'publish', 'parent':'3'}
body_test8_post3 = {'title':'New robot title','content':'This page was created by robot', 'status':'publish', 'parent':'3'}
body_test9_post = {}
...
body_test11_post = {'title':'New robot title','content':'Page to edit!', 'status':'publish', 'parent':'3'}
